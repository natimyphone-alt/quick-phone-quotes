...
function AuthPage() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "min-h-screen flex items-center justify-center p-4 bg-background", children: /* @__PURE__ */ jsxs(Card, { className: "w-full max-w-md shadow-lg border border-border", children: [
    /* @__PURE__ */ jsxs(CardHeader, { className: "text-center space-y-3 pb-2", children: [
      /* @__PURE__ */ jsx("div", { className: "mx-auto", children: /* @__PURE__ */ jsx("img", { src: "/logom_png.png", alt: "MyPhone", className: "w-16 h-16 rounded-full mx-auto" }) }),
      /* @__PURE__ */ jsx(CardTitle, { className: "text-2xl font-bold", children: "MyPhone Hub" }),
