...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-D-WggE9n.js");
...
const manifest = {
  "114a4314d0424fb03270f3bdf40223424b1ec0a12448a1cebfe96accbfaeb595": {
    ...
    importer: () => import("./sync.functions-OxhMs9b5.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D1Ss8V-o.js"),
    import("./start-CJP2wYNE.js"),
