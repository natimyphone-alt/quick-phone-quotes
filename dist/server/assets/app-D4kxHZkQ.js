...
import { LogOut, Home, Package, History, Settings, ClipboardList } from "lucide-react";
...
function AppLayout() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsx("header", { className: "bg-primary text-primary-foreground shadow-md sticky top-0 z-30", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-4 h-14 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxs(Link, { to: "/app", className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("img", { src: "/logom_png.png", alt: "MyPhone", className: "w-8 h-8 rounded-full" }),
        /* @__PURE__ */ jsx("span", { className: "font-semibold text-sm hidden sm:inline", children: "MyPhone Hub" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxs("span", { className: "hidden sm:inline text-sm opacity-90", children: [
          nombre || user.email,
          " ",
          isAdmin && /* @__PURE__ */ jsx("span", { className: "ml-1 text-xs bg-white/20 px-2 py-0.5 rounded", children: "Admin" })
        ] }),
