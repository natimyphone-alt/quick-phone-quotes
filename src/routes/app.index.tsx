...
import { Wrench, Cpu, History, Settings, BarChart3, ClipboardList, Package } from "lucide-react";
...
function Home() {
  ...
  const tiles = [
    ...
    { to: "/app/catalogo", title: "Catálogo de Repuestos", desc: "Proveedores, precios, calidad", icon: Package, color: "from-accent to-primary" },
    ...
    ...(isAdmin ? [
      ...
      { to: "/app/configuracion", title: "Configuración", desc: "Usuarios, sucursales, precios, mano de obra", icon: Settings, color: "from-primary to-accent" },
    ] : []),
  ];
